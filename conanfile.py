...
class DeasciifierConan(ConanFile):
    name = "deasciifier"
    version = "1.0.0"
    requires = ["morphological_analysis/1.0.0", "n_gram/1.0.0", "corpus/1.0.0", "dictionary/1.0.0", "util/1.0.0"]
    license = "GPL License"
    author = "Olcay Taner Yildiz olcay.yildiz@ozyegin.edu.tr"
    url = "https://github.com/StarlangSoftware/TurkishDeasciifier-CPP"
